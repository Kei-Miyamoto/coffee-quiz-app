      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => TestWidget(
            numberOfQuestions: params.getParam(
              'numberOfQuestions',
              ParamType.String,
            ),
            quizType: params.getParam(
              'quizType',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: 'RecentMistake',
          path: '/recentMistake',
          builder: (context, params) => const RecentMistakeWidget(),
        ),
        FFRoute(
          name: 'QuickTraining',
          path: '/quickTraining',
          builder: (context, params) => QuickTrainingWidget(
        ...
        FFRoute(
          name: 'HistoryDetail',
          path: '/historyDetail',
          builder: (context, params) => HistoryDetailWidget(
            quizSessionId: params.getParam(
              'quizSessionId',
              ParamType.int,
            ),
