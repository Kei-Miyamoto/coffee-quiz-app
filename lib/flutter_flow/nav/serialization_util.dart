  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case ChoiceTypeRow:
            return ChoiceTypeRow(data);
          case ChoicesRow:
            return ChoicesRow(data);
          case QuestionsRow:
            return QuestionsRow(data);
          case UserMistakesRow:
            return UserMistakesRow(data);
          case QuizSessionDetailsRow:
            return QuizSessionDetailsRow(data);
          case ResultsRow:
            return ResultsRow(data);
          case CategoriesRow:
            return CategoriesRow(data);
          case QuizSessionsRow:
            return QuizSessionsRow(data);
          default:
            return null;
        }
