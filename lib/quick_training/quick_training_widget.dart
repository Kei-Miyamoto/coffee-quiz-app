          ...
          child: Container(
            ...
            child: PagedListView<ApiPagingParams, dynamic>(
              pagingController: _model.setListViewController1(
                (nextPageMarker) => QuestionGroup.getQuestionAPICall.call(
              ...
              builderDelegate: PagedChildBuilderDelegate<dynamic>(
                ...
                itemBuilder: (context, _, quickQuestionsIndex) {
                  final quickQuestionsItem = _model.listViewPagingController1!
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Builder(
                                      builder: (context) {
                                        final quickChoice = getJsonField(
                                          quickQuestionsItem,
                                          r'''$['choice']''',
                                        ).toList();
                                        ...
                                        return ListView.builder(
                                          ...
                                          shrinkWrap: true,
                                          scrollDirection: Axis.vertical,
                                          itemCount: quickChoice.length,
                                          itemBuilder:
                                              (context, quickChoiceIndex) {
                                            final quickChoiceItem =
                                                quickChoice[quickChoiceIndex];
                                            return Visibility(
                                              visible: (String choiceItem) {
                                                return choiceItem == "true";
                                              }(getJsonField(
                                                quickChoiceItem,
                                                r'''$['is_answer']''',
                                              ).toString()),
