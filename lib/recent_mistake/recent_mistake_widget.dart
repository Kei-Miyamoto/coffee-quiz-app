                    ...
                    child: Column(
                      ...
                      children: [
                        FutureBuilder<ApiCallResponse>(
                          future: UserMistakeGroup.getUserMistakeAPICall.call(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final listViewGetUserMistakeAPIResponse =
                                snapshot.data!;

                            return Builder(
                              builder: (context) {
                                final getUserMistakeInfo =
                                ...
                                return ListView.builder(
                                  ...
                                  itemCount: getUserMistakeInfo.length,
                                  itemBuilder:
                                      (context, getUserMistakeInfoIndex) {
                                    final getUserMistakeInfoItem =
                                        getUserMistakeInfo[
                                            getUserMistakeInfoIndex];
                                    return Stack(
                                      children: [
                                        Align(
                                          alignment:
