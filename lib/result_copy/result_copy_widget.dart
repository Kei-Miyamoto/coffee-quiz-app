...
import 'result_copy_model.dart';
export 'result_copy_model.dart';

class ResultCopyWidget extends StatefulWidget {
  const ResultCopyWidget({
    super.key,
  ...
  @override
  State<ResultCopyWidget> createState() => _ResultCopyWidgetState();
}

class _ResultCopyWidgetState extends State<ResultCopyWidget> {
  late ResultCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResultCopyModel());
              ...
              children: [
                ...
                Container(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    future:
                        QuizSessionDetailGroup.getQuizSessionDetailAPICall.call(
                      ...
                      return Builder(
                        builder: (context) {
                          final resultQuizSessionsDetailInfo = getJsonField(
                            listViewGetQuizSessionDetailAPIResponse.jsonBody,
                            r'''$[*]''',
                          ).toList();
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder:
                                (context, resultQuizSessionsDetailInfoIndex) {
